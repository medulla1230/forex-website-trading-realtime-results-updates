            ...
            <div class="tab-pane fade active show" id="register" role="tabpanel" aria-labelledby="register-tab">
              <form class="form-row mt-4 mb-4 mb-sm-5 align-items-center form-flat-style" method="post" id="frmRegister">      
                ...
                <div class="form-group col-sm-12">
                  ...
                  <input type="text" name="name" value="" class="form-control" placeholder="Your Full Name:">
                ...
                <div class="form-group col-sm-6">
                 ...
                 <div class="form-group col-sm-6">
                  ...
                  <input type=text name="account_no" value="" class="form-control" placeholder="Account Number">
                </div>
                 <div id="account_error"  class="error_field"> </div>
                 <div class="form-group col-sm-12" >
                
                  <input type="email" name="email" value="" class="form-control" placeholder="Your E-mail Address:" >
                </div>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <input type=text name="mobile" value="" class="form-control" placeholder="Mobile Number (08033333333)" >
