      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-sm-6 text-center text-sm-left mb-2 mb-sm-0">
            <h1 class="breadcrumb-title mb-0">Forgot Password</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-9 col-sm-11">
          <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="false">Password</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="" href="<?php echo FRONT_SITE_PATH?>login" aria-selected="true">Login</a>
            </li>
          </ul>
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
              <form class="form-row mt-4 align-items-center form-flat-style" method="post" id="frmForgotPassword">
                    
                    <div id="form_forgot_msg" class="success_field"></div>

                <div class="form-group col-sm-12">
                  
                  <input name="user_email" value='' type="email" class="form-control" placeholder="Your E-mail Address:">
                </div>
                ...
                <img src="index26c0.html?a=show_validation_image&amp;PHPSESSID=15v1bqugr1hjj92b49br4k3v60&amp;rand=2568913">
                  ...
                  <button type="submit" class="btn btn-primary btn-flat btn-block" id="forgot_submit"> Submit</button>
                  <input type="hidden" name="type" value="forgot"/>
                    <div id="form_forgot_msg" class="success_field"></div>
                </div>
                <div class="col-sm-6">
                  <ul class="list-unstyled d-flex mb-1 mt-sm-0 mt-3 justify-content-sm-end">
                    <li class="mr-1"><a class="text-dark" href="<?php echo FRONT_SITE_PATH?>login">Back to login? Click here</a></li>
                  </ul>
                </div>
              </form>
            </div>
